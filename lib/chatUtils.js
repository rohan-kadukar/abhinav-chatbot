      ...
      body: JSON.stringify({
        contents: [{
          parts: [{
            ...
            QUESTION: ${query}
            IMPORTANT: Use only the context to answer. Give clear, accurate, and genuine info. Focus on Abhinav Academy and study-related topics. Math/study questions are allowed. Deflect unrelated queries politely. Keep it very short (min 1, max(2-3) sentences).`
          }]
